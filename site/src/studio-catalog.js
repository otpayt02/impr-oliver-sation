export const people = {
  oliver: { name: 'Oliver Payton', short: 'Oliver', note: 'Explore a musical or audio idea with Oliver.' },
};
...
export const story = [
  ...
  { id: 'book', name: 'Begin', words: ['Find', 'your sound.', 'Start something.'], colors: ['music-make', 'music-present', 'audio-present'], title: 'One practice, built around sound.', detail: 'Tell Oliver what you want to make possible.', output: 'Start with First Listen, or build a custom brief.' },
];
