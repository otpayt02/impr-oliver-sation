...
function loadResolutionFromTsconfigFile(configPath, seen) {
	...
	const baseUrl = (compilerOptions && typeof compilerOptions.baseUrl === "string" ? path.resolve(path.dirname(configPath), compilerOptions.baseUrl) : null) ?? resolution.baseUrl;
...
*/
function loadTsconfigResolutionForRoot(projectRoot) {
